...
>(({ className, children, hideArrow, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 native:h-11 flex-row items-center justify-between rounded-md bg-background px-3 py-2 font-regular text-base text-muted-foreground web:ring-offset-background web:focus:outline-none web:focus:ring-2 web:focus:ring-ring web:focus:ring-offset-2 [&>span]:line-clamp-1",
