...
export default function PrivacyScreen() {
  return (
    ...
    >
      <Text>
        Hey there! Thanks for using OtherSide. Here's the lowdown on what data
      ...
      <View className="gap-2 px-2">
        ...
        <Text>
          ✳︎ We share your user identity with Sentry for crash reporting and
          with Posthog for product analytics. This helps us make the app better
