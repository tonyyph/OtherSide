      ...
      <Pressable onPress={() => setHideTabBarStatus(false)}>
        ...
        >
          ...
          >
            ...
            >
              <TouchableOpacity
                className="p-2 border border-blue-100 rounded-full bottom-3 right-3 absolute bg-blue-50"
            ...
            <View className="flex-1 gap-4 px-4 justify-between">
              <View
              ...
              >
                ...
                <Text className="flex-1 text-muted-foreground text-medium font-medium">
              ...
              <View className="flex flex-row justify-between gap-2">
                ...
                <View className="flex flex-row items-center gap-3">
                  <View className="flex flex-row items-center gap-2">
                    ...
                    <Text className="text-foreground text-xs">{20}</Text>
                  </View>
                  <View className="flex flex-row items-center gap-2">
                    <ThumbsDown className="size-5 text-muted-foreground" />
                    <Text className="text-foreground text-xs">{10}</Text>
                  </View>
                  <View className="flex flex-row items-center gap-2">
                    <MessageCircle className="size-5 text-muted-foreground" />
                    <Text className="text-foreground text-xs">{99}</Text>
                  </View>
                </View>
              </View>
            </View>
